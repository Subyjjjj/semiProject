   ...
   <section>
      <ul>
         <li style="margin: 40px 0 25px; background: #ecf0f7">
            <h1 style="font-size: 2.2em;">공지사항 관리</h1>
         </li>
         ...
         <li class="board_t2" >
            ...
            <div class="mCtrl">
               ...
               &nbsp;<a href="#none" class="btnNormal"><span>공지사항등록</span></a>
               &nbsp;<a href="#none" class="btnNormal"><span>공지사항등록해제</span></a>
               &nbsp;<a href="#none" class="btnNormal"><span>글고정 지정</span></a>
               &nbsp;<a href="#none" class="btnNormal"><span>글고정 해제</span></a>
            </div>
