   ...
   <section>
      <ul>
         <li style="margin: 40px 0 25px; background: #ecf0f7">
            <h1 style="font-size: 2.2em;">전체주문목록</h1>
         </li>
                  ...
                  <tbody>
	                ...
	                <tr>
                     ...
                     <td colspan="3">
                        ...
                        <a id="productSearchBtn" class="btnNormal" onClick="window.open('select.jsp', '상품찾기', 'width=700, height=900'); return false;"><span>상품찾기 ▶</span></a>
	                   </td>
	                </tr>
	                ...
	                <tr>
		               ...
		               <td colspan="3" id="orderStatusCheck">
                           ...
                           <label class="gLabel eSelected" style="display: none;">
                          		 <input type="checkbox" name="orderStatus[]" class="fChk" value="N10"> 상품준비중</label>
                           <label class="gLabel eSelected"><input type="checkbox" name="orderStatus[]" class="fChk" value="N20"> 배송준비중
                           </label>
                           <label class="gLabel eSelected">
                         		  <input type="checkbox" name="orderStatus[]" class="fChk" value="N22"> 배송보류
                           </label>
                           <label class="gLabel eSelected">
                         		  <input type="checkbox" name="orderStatus[]" class="fChk" value="N21"> 배송대기
                           </label>
                           <label class="gLabel eSelected">
                         		  <input type="checkbox" name="orderStatus[]" class="fChk" value="N30"> 배송중
						   </label>
                           <label class="gLabel eSelected">
                           		<input type="checkbox" name="orderStatus[]" class="fChk" value="N40"> 배송완료
                           </label>
                       </td>
                     </tr>
                     ...
                     <tr>
                       ...
                       <td colspan="3">
                           <label class="gLabel">
                        	 	 <input type="checkbox" id="ec-order-search-cs-order-status" class="fChk ec-order-search-cs-order-status"> 전체
                           </label>
                           <label class="gLabel">
                          		 <input type="checkbox" name="orderStatusCancel" value="all" class="fChk ec-order-search-cs-order-status"> 취소
                           </label>
                           <label class="gLabel">
                          		 <input type="checkbox" name="orderStatusExchange" value="all" class="fChk ec-order-search-cs-order-status"> 교환
                           </label>
                           <label class="gLabel">
                          		 <input type="checkbox" name="orderStatusReturn" value="all" class="fChk ec-order-search-cs-order-status"> 반품
                           </label>
                           <label class="gLabel">
                          		 <input type="checkbox" name="orderStatusRefund" value="all" class="fChk ec-order-search-cs-order-status"> 환불
                           </label>
                       </td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td>
                           <label class="gLabel eSelected">
                           		<input type="radio" name="orderStatusPayment" class="fChk" value="all" checked="checked">  전체
                           </label>
                           <label class="gLabel">
                           		<input type="radio" name="orderStatusPayment" class="fChk" value="F">  입금전
                           </label>
                           <label class="gLabel">
                           		<input type="radio" name="orderStatusPayment" class="fChk" value="TA"> 입금완료
                           </label>
                           <label class="gLabel">
                           		<input type="radio" name="orderStatusPayment" class="fChk" value="P"> 결제완료
                           </label>
                        </td>
                        <th>회원구분</th>
                        <td>
